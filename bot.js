...
//
const yourID = "404206792005124096"; //Kendi İD'nizi Yazın
const setupCMD = "!kayıt" //İstediğiniz Komut Yapabilirsiniz örn : !kayıtol
let initialMessage = `Test`; //Dilediğiniz Şeyi Yazabilirsiniz
const roles = ["Test"]; //İstediğiniz Rolü Yazabilirsiniz
const reactions = ["✅"]; //İstediğiniz Emojiyi Ekleyebilirsiniz
const botToken = "NjIwOTg1MTcxNTA3Njc1MTM2.XZhZIQ.V5P-n6YtCy6pAYxAQ-iGkE81qj8";  //Buraya botunuzun tokenini koyunuz
