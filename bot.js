...
client.on('message', async msg => {
    ...
    .setColor('RED')
    .setDescription('Ne yazık ki sesli kanala katılabilmem için yeterili yetkim yok!'));
		}
...
.setColor("GREEN")
      .setDescription(`${playlist.title} adlı şarkı sıraya eklendi!`)
         ...
         .setDescription(`1 ile 10 arasında bir değer belirtiniz;
${videos.map(video2 => `[**${++index}**] **${video2.title}**`).join("\n")}`)
          ...
          msg.delete(5000)
					try {
						...
						console.error(err);
						 return msg.channel.sendEmbed(new Discord.RichEmbed()
            .setColor('RED')
            .setDescription('Uzun süre bir değer belirtilmediği için komut sıfırlandı!'));
                    }
    ...
    .setDescription('Lütfen bir sesli kanala katılınız!'));
     ...
     .setColor('RED')
     .setDescription('Ne yazık ki şuan herhangi bir müzik çalmamakta!'));                                              
		msg.channel.send(`**${serverQueue.songs[0].title}** Adlı müzik tekrar devam ettirilene kadar durduruldu!`);
		serverQueue.songs = [];
