    ...
    if(reset.includes(args[1])) {
                        if(!db.has(`${msg.author.id}.renk`)) {
                                const embed = new Discord.RichEmbed()
                                        .setDescription("Zaten renk değiştirilmemiş.")
                                        .setColor("BLACK")
                        ...
                        const embed = new Discord.RichEmbed()
                                .setDescription("Renk sıfırlandı.")
                                .setColor("BLACK")
                        msg.channel.send({embed})
                        return
                }
                if(!args[1]) {
                        const embed = new Discord.RichEmbed()
                                .setDescription("Bir renk kodu veya `sıfırla` yazınız.")
      .setFooter("Başına # koymayınız!")
                ...
                if(args[1].length !== 6) {
                        const embed = new Discord.RichEmbed()
                                .setDescription("Renk kod hane sınırı: 6 hanedir.")
      .setFooter("Başına # koymayınız!")
                                .setColor("BLACK")
                        msg.channel.send({embed})
                        return
        ...
        if(arm.includes(args[0])) {
                if(reset.includes(args[1])) {
                        if(!db.has(`${msg.author.id}.resim`)) {
                                const embed = new Discord.RichEmbed()
                                        .setDescription("Resim zaten ayarlanmamış.")
                                        .setColor("BLACK")
                                msg.channel.send({embed})
                                return
                        }
                        ...
                        const embed = new Discord.RichEmbed()
                                .setDescription("Resim sıfırlandı.")
                                .setColor("BLACK")
                        msg.channel.send({embed})
                        return
                }
