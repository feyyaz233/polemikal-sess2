...
var oyun = [
    ...
    setInterval(function() {
        ...
        client.user.setActivity(oyun[random], "NEMESİS");
        }, 2 * 2500);
  ...
  console.log(`[${moment().format('YYYY-MM-DD HH:mm:ss')}] BOT: Oyun ismi ayarlandı!`);const { RichEmbed, Client, Util, Message } = require("discord.js");
const fs = require("fs");
