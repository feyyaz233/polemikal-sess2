...
module.exports = async member => {
  var randomMsg = ["Sunucudan Çıkış yaptı"];
  ...
  if (!g) {
    ...
    const background = await Canvas.loadImage(
      "https://cdn.discordapp.com/attachments/573582370310062091/626167773336436766/Baslksz-1.png"
    );
  ...
  if (g) {
    ...
    const background = await Canvas.loadImage(
      "https://cdn.discordapp.com/attachments/545569894268272650/661188794527121458/normalcks.jpg"
    );
    ctx.drawImage(background, 0, 0, canvas.width, canvas.height);
